...
def sentToInput(sent,tokenizer):
...
def inference(args):
    ...
    model_input=sentToInput(sentence,_tokenizer)
...
if __name__=='__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, default="./best_model/14res_best_test_overall_f1.pth")
